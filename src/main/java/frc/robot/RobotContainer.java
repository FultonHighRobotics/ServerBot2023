...
public class RobotContainer {
  ...
  public SendableChooser<String> autoCooser = new SendableChooser<>();
  ...
  public RobotContainer() {
    autoCooser.setDefaultOption("None", "n");
    autoCooser.addOption("None", "n");
    autoCooser.addOption("Drive forward", "f");
    SmartDashboard.putData("Auto", autoCooser);
    ...
    TeleopDrive closedFieldRel = new TeleopDrive(drivebase,
     () -> ((Math.abs(-driverXbox.getLeftY()) > OperatorConstants.LEFT_Y_DEADBAND) ? -driverXbox.getLeftY() : 0) * power,
     () -> ((Math.abs(-driverXbox.getLeftX()) > OperatorConstants.LEFT_X_DEADBAND) ? -driverXbox.getLeftX() : 0) * power,
     () -> -driverXbox.getRightX() * power, () -> true,
     false);
